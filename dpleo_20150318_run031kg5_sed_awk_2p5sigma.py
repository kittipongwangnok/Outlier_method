...
lower_result = []
mean_result = []
upper = mean_32 + 2.5*std_32
lower =  mean_32 - 2.5*std_32
...
f = open('rej_data_32_2p5sigma.txt', 'w')
...
f = open('mean_data_32_2p5sigma.txt', 'w')
#for upper_result in upper_result:
...
lower_result = []
mean_result = []
upper = mean_42 + 2.5*std_42
lower =  mean_42 - 2.5*std_42
#print ('The upper bound value:', upper)
#print ('The lower bound value:', lower)
for i in range(len(x)):
    if y_42[i] < lower:
...
#lResults = upper_result
data_rej = lower_result + upper_result
f = open('rej_data_42_2p5sigma.txt', 'w')
#for upper_result in upper_result:
for i in range(len(data_rej)):
    f.write(str(data_rej[i])+ '\n')
f.close()
...
data_mean = mean_result
f = open('mean_data_42_2p5sigma.txt', 'w')
#for upper_result in upper_result:
for i in range(len(data_mean)):
    f.write(str(data_mean[i])+ '\n')
f.close()
...
lower_result = []
mean_result = []
upper = mean_52 + 2.5*std_52
lower =  mean_52 - 2.5*std_52
#print ('The upper bound value:', upper)
#print ('The lower bound value:', lower)
for i in range(len(x)):
    if y_52[i] < lower:
...
#lResults = upper_result
data_rej = lower_result + upper_result
f = open('rej_data_52_2p5sigma.txt', 'w')
#for upper_result in upper_result:
for i in range(len(data_rej)):
    f.write(str(data_rej[i])+ '\n')
f.close()
...
data_mean = mean_result
f = open('mean_data_52_2p5sigma.txt', 'w')
#for upper_result in upper_result:
for i in range(len(data_mean)):
    f.write(str(data_mean[i])+ '\n')
f.close()
...
lower_result = []
mean_result = []
upper = mean_34 + 2.5*std_34
lower =  mean_34 - 2.5*std_34
#print ('The upper bound value:', upper)
#print ('The lower bound value:', lower)
for i in range(len(x)):
    if y_34[i] < lower:
...
#lResults = upper_result
data_rej = lower_result + upper_result
f = open('rej_data_34_2p5sigma.txt', 'w')
#for upper_result in upper_result:
for i in range(len(data_rej)):
    f.write(str(data_rej[i])+ '\n')
f.close()
...
data_mean = mean_result
f = open('mean_data_34_2p5sigma.txt', 'w')
#for upper_result in upper_result:
for i in range(len(data_mean)):
    f.write(str(data_mean[i])+ '\n')
f.close()
...
lower_result = []
mean_result = []
upper = mean_53 + 2.5*std_53
lower =  mean_53 - 2.5*std_53
#print ('The upper bound value:', upper)
#print ('The lower bound value:', lower)
for i in range(len(x)):
    if y_53[i] < lower:
...
#lResults = upper_result
data_rej = lower_result + upper_result
f = open('rej_data_53_2p5sigma.txt', 'w')
#for upper_result in upper_result:
for i in range(len(data_rej)):
    f.write(str(data_rej[i])+ '\n')
f.close()
...
data_mean = mean_result
f = open('mean_data_53_2p5sigma.txt', 'w')
#for upper_result in upper_result:
for i in range(len(data_mean)):
    f.write(str(data_mean[i])+ '\n')
f.close()
...
lower_result = []
mean_result = []
upper = mean_54 + 2.5*std_54
lower =  mean_54 - 2.5*std_54
#print ('The upper bound value:', upper)
#print ('The lower bound value:', lower)
for i in range(len(x)):
    if y_54[i] < lower:
...
#lResults = upper_result
data_rej = lower_result + upper_result
f = open('rej_data_54_2p5sigma.txt', 'w')
#for upper_result in upper_result:
for i in range(len(data_rej)):
    f.write(str(data_rej[i])+ '\n')
f.close()
...
data_mean = mean_result
f = open('mean_data_54_2p5sigma.txt', 'w')
#for upper_result in upper_result:
for i in range(len(data_mean)):
    f.write(str(data_mean[i])+ '\n')
f.close()
...
#save file
#np.savetxt('data_mean_45_2p5sigma_demo.txt', np.array([mean_result]).T, fmt="%.10f")

'''
4. Plot graph to obtain the result
'''
########################################################
InputFile_1 = "mean_data_32_2p5sigma.txt"
Data_1   = np.genfromtxt(InputFile_1)

InputFile_2 = "rej_data_32_2p5sigma.txt"
Data_2   = np.genfromtxt(InputFile_2)

InputFile_3 = "mean_data_42_2p5sigma.txt"
Data_3   = np.genfromtxt(InputFile_3)

InputFile_4 = "rej_data_42_2p5sigma.txt"
Data_4   = np.genfromtxt(InputFile_4)

InputFile_5 = "mean_data_52_2p5sigma.txt"
Data_5   = np.genfromtxt(InputFile_5)

InputFile_6 = "rej_data_52_2p5sigma.txt"
Data_6   = np.genfromtxt(InputFile_6)

InputFile_7 = "mean_data_34_2p5sigma.txt"
Data_7   = np.genfromtxt(InputFile_7)

InputFile_8 = "rej_data_34_2p5sigma.txt"
Data_8   = np.genfromtxt(InputFile_8)

InputFile_9 = "mean_data_53_2p5sigma.txt"
Data_9   = np.genfromtxt(InputFile_9)

InputFile_10 = "rej_data_53_2p5sigma.txt"
Data_10   = np.genfromtxt(InputFile_10)

InputFile_11 = "mean_data_54_2p5sigma.txt"
Data_11   = np.genfromtxt(InputFile_11)

InputFile_12 = "rej_data_54_2p5sigma.txt"
...
'''
############################################################
np.savetxt("dpleo_20150318_run031kg5_sed_awk_2p5sigma.pre",
...
'''
############################################################
np.savetxt("dpleo_20150318_run031kg5_sed_awk_2p5sigma.pos",
